...
public class SensAtt_Pred_trainingExperiment : Experiment {
    ...
    protected override void PostMethod() {
        File.Move(Application.dataPath + "/Response_training.txt", "C:/Gian/GG_SensAtt_Prediction/02Data/ID" + myRunner.EmptyObject.GetComponent<ID>().ID_string + "/00Behavioural/" + "Training_response" + "_ID" + myRunner.EmptyObject.GetComponent<ID>().ID_string + ".txt");
        File.Move(Application.dataPath + "/Log_training.txt", "C:/Gian/GG_SensAtt_Prediction/02Data/ID" + myRunner.EmptyObject.GetComponent<ID>().ID_string + "/00Behavioural/" + "Training_Log" + "_ID" + myRunner.EmptyObject.GetComponent<ID>().ID_string + ".txt");
        File.Move(Application.dataPath + "/HandPositions.txt", "C:/Gian/GG_SensAtt_Prediction/02Data/ID" + myRunner.EmptyObject.GetComponent<ID>().ID_string + "/00Behavioural/" + "Training_Hand_Positions" + "_ID" + myRunner.EmptyObject.GetComponent<ID>().ID_string + ".txt");
